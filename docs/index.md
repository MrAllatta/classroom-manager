...
Each role has a full spec with purpose, inputs, outputs, handoff formats, and done criteria.
...
- **[Co-Teacher (Inés Vidal)](co-teacher.md)**

## Data

- **[Data Architecture](../data/README.md)** — Three-layer data model, access rules, privacy policy

## Archived

Historical documents preserved for reference: [archived/](archived/)
