...
9. **Teacher-next.** Role outputs should answer **what the teacher should do next** (or state clearly when the artifact is informational-only). See [`architecture_and_workflows.md`](../architecture_and_workflows.md#teacher-next-bar).
