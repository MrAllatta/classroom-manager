...
description: Curriculum Designer role for standards-aligned instructional content
---
...
## Inputs and outputs
- Consume Assessor mastery data and Planner pacing/time blocks.
- Produce artifacts like `CURRDES-SCOPE-*`, `CURRDES-ASSESS-*`, `CURRDES-LESSONS-*`.
